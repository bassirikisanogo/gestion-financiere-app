...
// Le backend renvoie des listes paginées { count, next, previous, results } ; on extrait results
const listData = (r) => (r.data && r.data.results !== undefined ? r.data.results : r.data)
...
export const categories = {
  list: () => api.get('/categories/').then(listData),
...
export const transactions = {
  list: (params) => api.get('/transactions/', { params }).then(listData),
...
export const budgets = {
  list: () => api.get('/budgets/').then(listData),
...
export const dettes = {
  list: (params) => api.get('/dettes/', { params }).then(listData),
...
export const factures = {
  list: (params) => api.get('/factures/', { params }).then(listData),
...
export const alertes = {
  list: () => api.get('/alertes/').then(listData),
